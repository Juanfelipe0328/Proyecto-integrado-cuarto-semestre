...
public class UsuarioDAO {
    ...
    private EnumRol convertirRol(String nombreRol) {
        ...
        return switch (nombreRol.toLowerCase().trim()) {
            case "docente"                                    -> EnumRol.DOCENTE;
            case "auxiliar logistica", "auxiliar logístico",
                 "auxiliar logistico"                         -> EnumRol.AUXILIAR_LOGISTICO;
            case "coordinador"                                -> EnumRol.COORDINADOR;
            case "directivo"                                  -> EnumRol.DIRECTIVO;
            case "administrador"                              -> EnumRol.ADMINISTRADOR;
