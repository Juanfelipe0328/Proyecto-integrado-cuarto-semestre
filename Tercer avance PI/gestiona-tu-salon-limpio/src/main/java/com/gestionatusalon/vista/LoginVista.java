...
public class LoginVista extends JFrame {
    ...
    private JPanel panelRegistro() {
        ...
        cmbRol = new JComboBox<>(new String[]{"Docente", "Auxiliar Logística", "Coordinador", "Directivo"});
    ...
    private void accionLogin() {
        ...
        switch (usuario.getRol()) {
            ...
            case COORDINADOR        -> new MenuCoordinadorVista(usuario).setVisible(true);
            case DIRECTIVO          -> new MenuDirectivoVista(usuario).setVisible(true);
            default -> {
    ...
    private void accionRegistro() {
        ...
        // Docente=5, Auxiliar=3, Coordinador=2, Directivo=4
        int[] idsRol = {5, 3, 2, 4};
